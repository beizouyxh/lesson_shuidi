const github=require('../../api/github.js');  //引入api
const timeRange = [
...
Page({
  data: {
    since:wx.getStorageSync(sinceCacheKey) ||timeRange[0],
    lang:languages[wx.getStorageSync(langCacheKey)] || languages[0],
    selectedIndices: [wx.getStorageSync(sinceCacheKey) ||0 , languages[wx.getStorageSync(langCacheKey)]
      || 0], //picker valuer
